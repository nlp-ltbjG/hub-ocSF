...
def beam_search(syllables, prefix, model, char2idx, idx2char, beam_size):
    """
...
def run(model, char2idx, idx2char, topk, beam_size):
    """
    交互式输入法主循环。
    ...
    while True:
        ...
        results = beam_search(syllables, confirmed, model, char2idx, idx2char, beam_size)
...
def main():
    ...
    parser.add_argument("--model_path", default="tsf_model.pt")
    ...
    run(model, char2idx, idx2char, args.topk, args.beam)
