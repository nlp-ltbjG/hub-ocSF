...
CKPT_DIR = ROOT / "outputs" / "lcqmc" / "checkpoints"
BERT_PATH = "bert-base-chinese"
#BERT_PATH  = ROOT.parent.parent / "pretrain_models" / "bert-base-chinese"
#CKPT_DIR   = ROOT / "outputs" / "checkpoints"
FIG_DIR    = ROOT / "outputs" / "lcqmc" / "figures"
LOG_DIR    = ROOT / "outputs" / "lcqmc" / "logs"
...
def plot_comparison_bar(results, save_path):
    ...
    ax.set_ylim(0, 1.0)
    ax.set_ylabel("Score")
    ax.set_title("Method Comparison on BQ Corpus Validation (4-layer BERT, 1 epoch)")
    ax.legend()
