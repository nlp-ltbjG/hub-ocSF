...
用法:
    python transformer_language_model.py --model lstm --epochs 20
    python transformer_language_model.py --model rnn  --epochs 20
    python transformer_language_model.py --model transformer  --epochs 20
"""
...
def main():
    ...
    model = LM(
        ...
        num_heads=args.num_heads if args.model == "transformer" else None,
    ).to(device)
