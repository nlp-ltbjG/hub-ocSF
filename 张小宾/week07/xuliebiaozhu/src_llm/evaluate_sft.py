...
DATA_DIR    = ROOT / "data" / "people_daily"
MODEL_PATH  = ROOT.parent.parent / "pretrain_models" / "Qwen2-0.5B-Instruct"
ADAPTER_DIR = ROOT / "people_outputs" / "sft_adapter"
LOG_DIR     = ROOT / "people_outputs" / "logs"
...
def main():
    ...
    if not ckpt_dir.exists():
        ...
        print("  LoRA（默认）保存到:   people_outputs/sft_adapter/")
        print("  全量微调保存到:        people_outputs/sft_full_ckpt/")
        return
