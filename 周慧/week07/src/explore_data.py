...
DATA_DIR = ROOT / "data" / "peoples_daily"# 修改前
        ...
        for token, tag in zip(tokens, ner_tags):
            if tag.startswith("B-"):
                ...
                if current_entity:
                    ...
                    entities_by_type[etype].append("".join(current_entity))
                # 开始新实体
                current_entity = [token]
                current_type = tag[2:]  # 提取实体类型，如 "LOC"
